...
![125-1](images/125-1.png)

AdminLTE托管在GitHub上，可以通过下面的地址下载：

https://github.com/ColorlibHQ/AdminLTE/releases

![125-2](images/125-2.png)
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="http://localhost:8000/assets/dashboard/#" target="_blank">CMDB项目测试</a>.</strong> All rights reserved.
  </footer>
